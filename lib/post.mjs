...
export function buildNoteFrontmatter(properties, slug, dateStr) {
...
export function buildBookmarkFrontmatter(properties, slug, dateStr) {
...
export function buildReplyFrontmatter(properties, slug, dateStr) {
...
export function buildLikeFrontmatter(properties, slug, dateStr) {
...
export function buildRepostFrontmatter(properties, slug, dateStr) {
